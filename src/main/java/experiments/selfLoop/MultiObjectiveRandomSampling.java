...
//
//    public static Tuple3<Double, Double, Double> evaluate(BNClassic<BitSet, Boolean> bn) {
...
//    }
//
//    public static void checkIfDominated(Set<Tuple3<Integer, BNClassic<BitSet, Boolean>, Tuple3<Double, Double, Double>>> paretoFront,
//                                        Tuple3<Integer, BNClassic<BitSet, Boolean>, Tuple3<Double, Double, Double>> tuple) {
...
//
//       randomGeneratorr = RandomnessFactory.newPseudoRandomGenerator(seed);
//
...
//        Set<Tuple3<Integer, BNClassic<BitSet, Boolean>, Tuple3<Double, Double, Double>>> paretoFront = new HashSet<>();
//        BNClassic<BitSet, Boolean> current_bn;
//        Tuple3<Integer, BNClassic<BitSet, Boolean>, Tuple3<Double, Double, Double>> current_tuple;
//        int counter = 0;
//
//
